...
WebUI.click(findTestObject('Object Repository/OR_Incredible Connection/Games/a_PlayStation'))

WebUI.click(findTestObject('Object Repository/OR_Incredible Connection/Games/button_Add to Cart'))
