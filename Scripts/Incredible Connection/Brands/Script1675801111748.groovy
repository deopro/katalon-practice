...
WebUI.click(findTestObject('Object Repository/OR_Incredible Connection/Brands/span_Brands'))

WebUI.click(findTestObject('Object Repository/OR_Incredible Connection/Brands/img'))
